...
int main(int, char* []) {
    ...
    try {
        ...
        // std::ifstream binary("ANU");
        // uint32_t a;
        // const int size = sizeof(a);
        
        // class TRNG {
          
        //   explicit TRNG(char = 'ANU');
        ...
        //   sample_type next(ifstream &uni_num = binary) const {
        //     uni_num.read((char*)&a, size);
        ...
        mcengine1 = MakeMCEuropeanEngine<TrueRandom>(bsmProcess)
            .withSteps(timeSteps)
        ...
        mcengine3 = MakeMCAmericanEngine<TrueRandom>(bsmProcess)
            .withSteps(100)
